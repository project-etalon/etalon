...
def num_fixed_qps_values(capacity_search: CapacitySearch):
        ...
        if capacity_search.args.wandb_project is not None and capacity_search.args.enable_wandb_sweep:
            best_run = wandb.Api().run(f"{capacity_search.args.wandb_project}/{best_run_id}")
